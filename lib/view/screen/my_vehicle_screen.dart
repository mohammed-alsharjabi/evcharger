...
class _MyVehicleScreenState extends State<MyVehicleScreen> {
  ...
  VehicleControllerImp controller = Get.put(VehicleControllerImp());
            ...
            child: Scaffold(
                ...
                body: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    VehicleModel data = controller.getMyvehicleData[index];
                    return Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text("${data.vehicleBrand!}-${data.vehicleModel!}",style: TextThemeHelper.titleMediumOpenSans,),
                                        ...
                                        Row(
                                          children: [
                                            CustomImageView(imagePath: ImageConstant.imgCharges1stIcon,
                                              height: getSize(24),
                                              width: getSize(24),),
                                            Text("Type ${data.chargeType!}",style: TextThemeHelper.bodymedium16black400,),
                                          ],
                                        ),
                                        SizedBox(width: getHorizontalSize(16),),
                                        Row(
                                          children: [
                                            CustomImageView(imagePath: ImageConstant.imgPlug5th,
                                              height: getSize(24),
                                              width: getSize(24),),
                                            Text("CCS ${data.chargePort!}",style: TextThemeHelper.bodymedium16black400,),
                                          ],
                                        ),
                                      ],
                                    ),
