...
class AppColor {
  ...
  static const Color gray2 = Color.fromARGB(255, 66, 66, 66);
  static const Color gray3 = Color(0xFF7C7C7C);
  static const Color gray4 = Color(0x19606470);
  static const Color gray5 = Color(0xFFA3A3B5);
  ...
  static const Color errorColor = Color(0xFFD93636);
  static const Color yellowTextColor = Color(0xFFE1A200);
  static const Color amber500 = Color(0xFFFFC107);
  static const Color primaryVariant = Color(0xFFCD3232);
  static const Color indigoA700 = Color(0xFF1A2ADF);

  static const Color cyan50 = Color(0xFFDEF5FA);
  static const Color teal50 = Color(0xFFE1E8EC);
}
